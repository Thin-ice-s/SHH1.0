...
from shh.client.transfer_client import ChunkedTransferMixin
from shh.discovery.rendezvous import RendezvousManager


class SHHClient(ChunkedTransferMixin):
    ...
    def _call(self, endpoint: str, payload: Optional[Dict[str, Any]] = None, timeout: float = 120.0) -> Dict[str, Any]:
        """Adapter used by ChunkedTransferMixin (upload/download/put_text/get_text)."""
        return self._request("POST", endpoint, payload or {}, timeout=timeout)
